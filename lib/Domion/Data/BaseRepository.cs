...
namespace Domion.Data
{
    ...
    public abstract class BaseRepository<TEntity, TKey> where TEntity : class //: IQueryManager<TEntity>, IEntityManager<TEntity, TKey> where TEntity : class
    {
